...
class PrenotazioneControllerTest {
    ...
    void testGetPrenotazione_Italiano() throws Exception {
        ResponseEntity<String> response = controller.getPrenotazione("italiano");
    ...
    void testGetPrenotazione_Inglese() throws Exception {
        ResponseEntity<String> response = controller.getPrenotazione("inglese");
        assertEquals(HttpStatus.OK, response.getStatusCode());
    ...
    void testGetPrenotazione_LinguaNonSupportata() throws Exception {
        ResponseEntity<String> response = controller.getPrenotazione("spagnolo");
