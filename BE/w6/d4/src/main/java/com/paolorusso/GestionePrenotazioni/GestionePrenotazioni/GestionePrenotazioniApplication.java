package com.paolorusso.GestionePrenotazioni.GestionePrenotazioni;
...
import com.paolorusso.GestionePrenotazioni.GestionePrenotazioni.config.Configuration;
...
import com.paolorusso.GestionePrenotazioni.GestionePrenotazioni.services.RoleService;
...
public class GestionePrenotazioniApplication implements CommandLineRunner {
	...
	public void popolaNuovoDB() {
		Utente u1 = inserisciUtente("LaDea", "Anna Falchi", "a@falchi.it", "pass1");
		Utente u2 = inserisciUtente("PorcaPuttena", "Lino Banfi", "l@banfi.it", "pass2");
	...
	public Utente inserisciUtente(String u, String n, String e, String p) {
		Utente u1 = (Utente) ctx.getBean("utente", u, n, e, p);
		utServ.insert(u1);
		return u1;
	}
